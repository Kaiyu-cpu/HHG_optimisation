...
def fitness_func_integral(I1, I2, I3, delay_12,delay_13, t=t, x=x, plot=False,Print=False,title='',show_driving=False,save=False):
...
params=optimizer.max['params']
params=list(params.values())
fitness_func_integral(params[0],params[1],params[2],params[3],params[4],plot=True,Print=True,title='best')
#plot_spectrum_chirped(params,xmin=40,xmax=46)